    ...
    render() {
        return (
            <article className="holy-grail__middle">
                <button className="btn btn-primary m-2" onClick={this.AddCustomerHandle.bind(this)}>Add Customer</button>
                    ...
                    <div className="user_edit user_add input-group-text ">
                        <form onSubmit={this.onUpdateHandle.bind(this)}>
                            ...
                            <button
                                ...
                                className="cancle_btn btn btn-danger">Cancel</button>
                ...
                {this.state.isAdd && (
                    ...
                    <div className="user_add input-group-text ">
                        <form onSubmit={this.onSubmitHandle.bind(this)}>
                            ...
                            <button onClick={this.CancelCustomerHandle.bind(this)} className="cancle_btn btn btn-danger">Cancel</button>
