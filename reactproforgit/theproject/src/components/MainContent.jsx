...
if (i==2||i==5)
    string[i]=".";
        ...
        this.onStatusHandle(this.state.hide);    
          this.onGenerateHandle(this.state.people);
    }
    ...
    onDeleteHandle(){ 
            ...
            this.onGenerateHandle(this.state.people);
            //transfer the people array to generate and update the id to the new index aftet the delete process.
}           
        ...
        return (
            <article className="holy-grail__middle">
                ...
                <div className='person_add'>
                    <form   className='person_add' onSubmit={this.onSubmitHandle.bind(this)} >  
                    {/* (this) used to refer it to the  whole class in the function submit! */} 
                    <ol>
                ...
                <div>
                            ...
                            <span className='person_id'>{person.id} </span>
                             <span className='person_avatar'>{person.avatar}</span>
                            ...
                            <span className='person_actions'>{person.actions}</span>
                            </div>
                             }
                            
                           { index>0&&
                           <div className='person'>
                             <span className='person_id'>{index} </span>
